...
CREATE TABLE tartalom (
  id INT PRIMARY KEY,
  sutiid INT NOT NULL,
  mentes VARCHAR(20) NOT NULL,
  CONSTRAINT fk_tartalom_suti FOREIGN KEY (sutiid) REFERENCES suti(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
INSERT INTO users (family_name, given_name, login, email, password_hash) VALUES ('Krakovszki', 'Zalán', 'admin', 'krakovszki@gmail.com', '$2y$10$kYudJUCw1.H1LLPRMIsT0eiHEwJ/09UYCouEAJwkz2T3uvEbZiCAW');
...
INSERT INTO messages (user_id, name, email, subject, message) VALUES
  (NULL, 'Vendég', 'vendeg@example.com', 'Hajnali kedvezmény', 'Érdeklődöm, hogy hétvégén is jár-e a 30% kedvezmény hajnali 4 és 6 között.');
